...
const std::vector<ConsoleKeyword> g_consoleKeywords{
  ...
  { "addLocal", true, "addr [, {doTCP=true, reusePort=false, tcpFastOpenQueueSize=0, interface=\"\", cpus={}, xsk=false}]", "add `addr` to the list of addresses we listen on" },
  ...
  { "setLocal", true, "addr [, {doTCP=true, reusePort=false, tcpFastOpenQueueSize=0, interface=\"\", cpus={}, xsk=false}]", "reset the list of addresses we listen on to this address" },
